...
# e.g. `export ORB_SLAM3_ROOT_DIR=~/ORB_SLAM3`

# Default location of ORB_SLAM3
...
if (DEFINED ORB_SLAM3_ROOT_DIR)
    get_filename_component(ORB_SLAM3_PARENT_DIR ${ORB_SLAM3_ROOT_DIR} DIRECTORY)
    set(_ORB_SLAM3_SEARCHES ${ORB_SLAM3_ROOT_DIR} ${ORB_SLAM3_PARENT_DIR} ${_ORB_SLAM3_SEARCHES})
endif()
...
find_path(ORB_SLAM3_CAM_INCLUDE_DIR GeometricCamera.h
          PATHS ${_ORB_SLAM3_SEARCHES} PATH_SUFFIXES include/CameraModels)

find_path(SOPHUS_INCLUDE_PATH sophus/so2.hpp
          PATHS ${_ORB_SLAM3_SEARCHES} PATH_SUFFIXES Thirdparty/Sophus)
...
find_package_handle_standard_args(ORB_SLAM3  DEFAULT_MSG
                                  ORB_SLAM3_LIBRARY ORB_SLAM3_INCLUDE_DIR DBoW2_INCLUDE_DIR DBoW2_LIBRARY g2o_LIBRARY ORB_SLAM3_CAM_INCLUDE_DIR SOPHUS_INCLUDE_PATH)
...
set(ORB_SLAM3_INCLUDE_DIRS ${ORB_SLAM3_INCLUDE_DIR} ${DBoW2_INCLUDE_DIR} ${ORB_SLAM3_CAM_INCLUDE_DIR} ${SOPHUS_INCLUDE_PATH})